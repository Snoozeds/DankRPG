    ...
    async execute(interaction) {
        ...
        if(item === 'axe') {
            ...
            if(wood < 5 && stone < 10 || wood === null && stone === null) {
                await interaction.reply({"content": "You don't have enough materials to craft this item!\nYou need: 5 wood and 10 stone.", "ephemeral": true});
            } else {
            ...
            if(wood < 25 && stone < 50 || wood === null && stone === null) {
                await interaction.reply({"content": "You don't have enough materials to craft this item!\nYou need: 25 wood and 50 stone.", "ephemeral": true});
            } else {
